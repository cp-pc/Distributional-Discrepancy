...
class DataLoader():
    ...
    def create_batches_train_list(self, tokens):
        self.token_stream = [fill_seq(sentence, padded_length=self.seq_length, fill_token=self.padding_token) for
                             sentence in tokens]
...
class BalanceDisDataloader():
    ...
    def load_train_data_list_file(self, positive_tokens, negative_file):
        # Load data
        positive_examples = [fill_seq(sentence, padded_length=self.seq_length, fill_token=self.padding_token) for
                             sentence in positive_tokens]
    ...
    def load_train_data_list(self, positive_tokens, negative_tokens):
        ...
        positive_examples = [fill_seq(sentence, padded_length=self.seq_length, fill_token=self.padding_token) for
                             sentence in positive_tokens]
        negative_examples = [fill_seq(sentence, padded_length=self.seq_length, fill_token=self.padding_token) for
                             sentence in negative_tokens]
